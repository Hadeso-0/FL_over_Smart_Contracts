...
contract Federation {
    ...
    */
    function store_params(int256[][][] memory _layer_params) public returns (int256) {

        require( participated[msg.sender] == false, "Sender already stored parameters.");
